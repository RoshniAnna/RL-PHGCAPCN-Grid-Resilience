...
# ----------------------------
files = {
    "PHCAPAM": r"PHCAPAM_TestSample2_BestModel_results.xlsx",
    "CAPAM": r"CAPAM_TestSample2_BestModel_results.xlsx"
}
...
roll_win = max(3, len(df)//30)  # adapt window to number of scenarios
...
# Save
# ----------------------------
fig.savefig("Reward_trend_Test2.pdf", bbox_inches="tight")
...
plt.tight_layout()
fig.savefig("Modelwinrate_test2.pdf", bbox_inches='tight')
...
fig.tight_layout(pad=0.1)
fig.savefig("Violin_plot_test2.pdf", bbox_inches="tight")
plt.show()