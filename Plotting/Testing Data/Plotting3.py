...
# ----------------------------
files = {
    "PHCAPAM": r"PHCAPAM_TestSample3_BestModel_results.xlsx",
    "CAPAM": r"CAPAM_TestSample3_BestModel_results.xlsx"
}
...
# Save
# ----------------------------
fig.savefig("Reward_trend_Test3.pdf", bbox_inches="tight")
...
plt.tight_layout()
fig.savefig("Modelwinrate_test3.pdf", bbox_inches='tight')
...
fig.tight_layout(pad=0.1)
fig.savefig("Violin_plot_test3.pdf", bbox_inches="tight")
plt.show()