...
scenario_file = os.path.join(base_dir, "Test Dataset", "Outage_scenarios_test_cleaned.pkl") # CHANGE TEST SAMPLE HERE
...
df_results.to_excel(os.path.join(os.path.dirname(__file__), "PHCAPAM_TestSample1_BestModel_results.xlsx"), index=False) # CHANGE according to model
...
summary_df.to_excel(os.path.join(os.path.dirname(__file__), "PHCAPAM_TestSample1_BestModel_summary.xlsx"), index=False) # CHANGE according to model
