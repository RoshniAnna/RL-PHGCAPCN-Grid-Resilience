...
if __name__ == '__main__':
    ...
    ckpt_dir = os.path.join(SCRATCH_DIR, "ckpts_CAPAM")
    tensorboard_log_dir = os.path.join(SCRATCH_DIR, "TensorboardLogs")
    save_prefix = os.path.join(SCRATCH_DIR, "models", "CAPAM")
    ckpt_name = "CAPAM"
    ...
    #                                      name_prefix=training_config.node_encoder+"_debug")
    ...
    model = PPO(
        ...
        ).learn(total_timesteps=training_config.total_steps, callback=CallbackList([checkpoint_callback,
                                                                                    eval_callback,
                                                                                    WandbCallback(
    ...
    artifact = wandb.Artifact("CAPAM_final_model", type="model")
