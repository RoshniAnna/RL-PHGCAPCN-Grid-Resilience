...
def get_training_config(args=None):
    ...
    parser.add_argument('--batch_size', type=int, default=2500, help='Batch size for training')#20000
    parser.add_argument('--n_steps', type=int, default=1000, help='Number of steps for rollout')#50000
